# precificacao
Aplicação Web open-source (só com HTML, CSS e JS puro) que faz o Custeio por Absorção.
...
[Call to Action + Link]
O resultado é o Preço de Venda Ideal e o Lucro Real. Sem banco de dados, sem login, tudo rodando direto no navegador.
